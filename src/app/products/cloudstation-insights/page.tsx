...
const product = PRODUCTS_CONTENT["cloudstation-insights"];
const insights = product.insightsExperience;
...
export const metadata: Metadata = {
  ...
  description:
    "Analyze SD-WAN flows, network scores, usage, storage, and custom exports with CloudStation Insights by Lavelle Networks.",
  alternates: {
    canonical: "/products/cloudstation-insights",
  },
  openGraph: {
    title: "CloudStation Insights | Lavelle Networks",
    description:
      "Advanced network flow analysis, dynamic path selection, network scores, and usage visibility for enterprise SD-WAN.",
    url: "/products/cloudstation-insights",
    images: [
      {
        url: "/og/default.png",
        width: 1200,
        height: 630,
        alt: "CloudStation Insights by Lavelle Networks",
      },
    ],
  },
};
...
const productJsonLd = {
  ...
  url: `${SITE_URL}/products/cloudstation-insights`,
};

function getInsightsContent() {
  if (!insights) {
    throw new Error("CloudStation Insights content is missing.");
  }

  return insights;
}

export default function CloudStationInsightsPage() {
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mx-auto mt-14 grid max-w-4xl gap-6 md:grid-cols-2">
              {product.licenses.map((license) => (
                ...
                >
                  <TrendingUp className="h-10 w-10 text-[#0078D4]" aria-hidden="true" />
